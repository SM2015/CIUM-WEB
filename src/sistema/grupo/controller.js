(function(){
	...
	.controller('GrupoCtrl',
	       ['$rootScope', '$scope', '$mdSidenav','$location','$mdBottomSheet','Auth','Menu', '$http', '$window', '$timeout', '$route', 'flash', 'errorFlash', 'moduloAccion', 'sisGrupo', 'CrudDataApi', 
	function($rootScope,   $scope,   $mdSidenav,  $location,  $mdBottomSheet,  Auth,  Menu,   $http,   $window,   $timeout,   $route,   flash,   errorFlash,   moduloAccion, sisGrupo,   CrudDataApi){
